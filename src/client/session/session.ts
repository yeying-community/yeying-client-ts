...
export class SessionProvider {
     ...
     */
    detail(uid: string) {
        return new Promise<SessionDetailJson>(async (resolve, reject) => {
            ...
            try {
                ...
                return resolve(toJson(SessionDetailSchema, detail, { alwaysEmitImplicit: true }) as SessionDetailJson)
            } catch (err) {
