...
export class SessionProvider {
    ...
    return new Promise<SessionMetadata>(async (resolve, reject) => {
      ...
      try {
        ...
        header = await this.authenticate.createHeader(
          toBinary(CreateSessionRequestBodySchema, body),
        );
      } catch (err) {
  ...
  search(page: number = 1, pageSize: number = 10, uid?: string, name?: string) {
    return new Promise<SessionMetadata[]>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(SearchSessionRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(SearchSessionRequestSchema, {
        header: header,
        body: body,
      });
      try {
  ...
  delete(uid: string) {
    return new Promise<void>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(DeleteSessionRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(DeleteSessionRequestSchema, {
        header: header,
        body: body,
      });
      try {
  ...
  detail(uid: string) {
    return new Promise<SessionDetail>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(SessionDetailRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(SessionDetailRequestSchema, {
        header: header,
        body: body,
      });
      try {
  ...
  update(session: SessionMetadata) {
    return new Promise<SessionMetadata>(async (resolve, reject) => {
      ...
      try {
        ...
        await signSessionMetadata(this.authenticate, session);
        header = await this.authenticate.createHeader(
          toBinary(UpdateSessionRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(UpdateSessionRequestSchema, {
        header: header,
        body: body,
      });
      try {
