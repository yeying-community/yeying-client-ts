  ...
  download(
    ...
    return new Promise<AssetMetadata>(async (resolve, reject) => {
      try {
        ...
        console.log(
          `Fail to download asset, namespaceId=${namespaceId}, hash=${hash}`,
          e,
        );
        return reject(e);
      }
