...
export class AssetProvider {
    ...
    return new Promise<AssetMetadata[]>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(SearchAssetRequestBodySchema, body),
        );
      } catch (err) {
  ...
  update(asset: Partial<AssetMetadata>) {
    return new Promise<AssetMetadata>(async (resolve, reject) => {
      ...
      try {
        ...
        header = await this.authenticate.createHeader(
          toBinary(UpdateAssetRequestBodySchema, body),
        );
      } catch (err) {
  ...
  detail(namespaceId: string, hash: string) {
    return new Promise<AssetMetadata>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(AssetDetailRequestBodySchema, body),
        );
      } catch (err) {
  ...
  delete(namespaceId: string, hash: string) {
    return new Promise<void>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(DeleteAssetRequestBodySchema, body),
        );
      } catch (err) {
  ...
  sign(asset: AssetMetadata) {
    return new Promise<AssetMetadata>(async (resolve, reject) => {
      ...
      try {
        ...
        header = await this.authenticate.createHeader(
          toBinary(SignAssetRequestBodySchema, body),
        );
      } catch (err) {
