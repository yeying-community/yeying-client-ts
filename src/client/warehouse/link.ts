...
export class LinkProvider {
  ...
  create(
    ...
    return new Promise<LinkDetail>(async (resolve, reject) => {
      const link = create(LinkMetadataSchema, {
        ...
        type: type,
        visitors:
          visitors && visitors.length > 0 ? visitors.join(",") : undefined,
      });
      ...
      try {
        ...
        header = await this.authenticate.createHeader(
          toBinary(CreateLinkRequestBodySchema, body),
        );
      } catch (err) {
        console.error(
          "Fail to create header when creating link for asset",
          err,
        );
        return reject(err);
      }
  ...
  search(
    ...
    return new Promise<LinkMetadata[]>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(SearchLinkRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(SearchLinkRequestSchema, {
        header: header,
        body: body,
      });
  ...
  detail(uid: string) {
    return new Promise<LinkDetail>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(LinkDetailRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(LinkDetailRequestSchema, {
        header: header,
        body: body,
      });
  ...
  disable(uid: string) {
    return new Promise<void>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(DisableLinkRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(DisableLinkRequestSchema, {
        header: header,
        body: body,
      });
  ...
  visitors(uid: string, page: number = 1, pageSize: number = 10) {
    return new Promise<VisitorMetadata[]>(async (resolve, reject) => {
      ...
      try {
        header = await this.authenticate.createHeader(
          toBinary(LinkVisitorRequestBodySchema, body),
        );
      } catch (err) {
      ...
      const request = create(LinkVisitorRequestSchema, {
        header: header,
        body: body,
      });
