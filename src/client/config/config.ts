...
export class ConfigProvider {
    ...
    get(key: string, type: ConfigTypeEnum = ConfigTypeEnum.CONFIG_TYPE_USER) {
        return new Promise<ConfigMetadataJson>(async (resolve, reject) => {
            ...
            try {
                ...
                return resolve(toJson(ConfigMetadataSchema, res.body?.config as ConfigMetadata, {alwaysEmitImplicit: true}))
            } catch (err) {
    ...
    set(key: string, value: string) {
        return new Promise<ConfigMetadataJson>(async (resolve, reject) => {
            ...
            const body = create(SetConfigRequestBodySchema, {
            ...
            const request = create(SetConfigRequestSchema, {
                header: header,
                body: body
            })
            try {
