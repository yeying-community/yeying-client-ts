...
import type { LanguageCodeEnum, LanguageCodeEnumJson } from "../common/code_pb";
 ...
 */
export const file_yeying_api_bulletin_bulletin: GenFile =
  /*@__PURE__*/
  fileDesc(
    "",
 ...
 */
export type BulletinListRequest =
  Message<"yeying.api.bulletin.BulletinListRequest"> & {
    /**
 ...
 * @generated from message yeying.api.bulletin.BulletinListRequest
 */
export type BulletinListRequestJson = {
  /**
   * @generated from field: yeying.api.common.MessageHeader header = 1;
   */
 ...
 */
export const BulletinListRequestSchema: GenMessage<
  BulletinListRequest,
  BulletinListRequestJson
> = /*@__PURE__*/ messageDesc(file_yeying_api_bulletin_bulletin, 0);

/**
 * @generated from message yeying.api.bulletin.BulletinListRequestBody
 */
export type BulletinListRequestBody =
  Message<"yeying.api.bulletin.BulletinListRequestBody"> & {
    /**
 ...
 * @generated from message yeying.api.bulletin.BulletinListRequestBody
 */
export type BulletinListRequestBodyJson = {
  /**
   * @generated from field: yeying.api.bulletin.BulletinCodeEnum code = 1;
   */
 ...
 */
export const BulletinListRequestBodySchema: GenMessage<
  BulletinListRequestBody,
  BulletinListRequestBodyJson
> = /*@__PURE__*/ messageDesc(file_yeying_api_bulletin_bulletin, 1);

/**
 * @generated from message yeying.api.bulletin.BulletinListResponse
 */
export type BulletinListResponse =
  Message<"yeying.api.bulletin.BulletinListResponse"> & {
    /**
     * @generated from field: yeying.api.common.MessageHeader header = 1;
     */
    header?: MessageHeader;
 ...
 * @generated from message yeying.api.bulletin.BulletinListResponse
 */
export type BulletinListResponseJson = {
  /**
   * @generated from field: yeying.api.common.MessageHeader header = 1;
   */
  header?: MessageHeaderJson;
 ...
 */
export const BulletinListResponseSchema: GenMessage<
  BulletinListResponse,
  BulletinListResponseJson
> = /*@__PURE__*/ messageDesc(file_yeying_api_bulletin_bulletin, 2);

/**
 * @generated from message yeying.api.bulletin.BulletinListResponseBody
 */
export type BulletinListResponseBody =
  Message<"yeying.api.bulletin.BulletinListResponseBody"> & {
    /**
 ...
 * @generated from message yeying.api.bulletin.BulletinListResponseBody
 */
export type BulletinListResponseBodyJson = {
  /**
   * @generated from field: yeying.api.common.ResponseStatus status = 1;
   */
 ...
 */
export const BulletinListResponseBodySchema: GenMessage<
  BulletinListResponseBody,
  BulletinListResponseBodyJson
> = /*@__PURE__*/ messageDesc(file_yeying_api_bulletin_bulletin, 3);

/**
 * @generated from message yeying.api.bulletin.SolutionMetadata
 */
export type SolutionMetadata =
  Message<"yeying.api.bulletin.SolutionMetadata"> & {
    /**
 ...
 * @generated from message yeying.api.bulletin.SolutionMetadata
 */
export type SolutionMetadataJson = {
  /**
   * @generated from field: string publisher = 1;
   */
  publisher?: string;
 ...
 */
export const SolutionMetadataSchema: GenMessage<
  SolutionMetadata,
  SolutionMetadataJson
> = /*@__PURE__*/ messageDesc(file_yeying_api_bulletin_bulletin, 4);
 ...
 */
export const SolutionCardSchema: GenMessage<SolutionCard, SolutionCardJson> =
  /*@__PURE__*/
 ...
 * @generated from enum yeying.api.bulletin.BulletinCodeEnum
 */
export type BulletinCodeEnumJson = "BULLETIN_CODE_SOLUTION";

/**
 * Describes the enum yeying.api.bulletin.BulletinCodeEnum.
 */
export const BulletinCodeEnumSchema: GenEnum<
  BulletinCodeEnum,
  BulletinCodeEnumJson
> = /*@__PURE__*/ enumDesc(file_yeying_api_bulletin_bulletin, 0);
...
}> = /*@__PURE__*/ serviceDesc(file_yeying_api_bulletin_bulletin, 0);
